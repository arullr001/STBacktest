...
def process_param_combo(args):
    ...
    try:
        ...
        print(f"Buffer: {buffer_multiplier}")
        print(f"Stop: {hard_stop_distance}")
...
class BatchProcessor:
    ...
    def __init__(self, directory_manager, memory_manager):
        ...
        self.current_utc = "2025-06-12 19:57:03"  # Updated timestamp
    ...
    def process_batch(self, df, param_combinations, batch_start, batch_size, max_workers=4):
        ...
        print(f"Actual batch size: {len(batch_combinations)}")
...
def main():
    ...
    """
    CURRENT_UTC = "2025-06-12 20:00:05"  # Updated timestamp
    CURRENT_USER = "arullr001"           # Updated user
